    ...
    <script>
            ...
            $.ajax({
                url: '{{ route('Channai44Controller.store') }}',
                method: 'POST',
        ...
        $(document).on('click', '.edit-btn', function() {
            ...
            $('#data-id').val();
            let editteUrl = '{{ route('Channai44Controller.edit', ['Channai44Controller' => 'id']) }}'.replace(
                'id', userId);
        ...
        $(document).on('click', '.delete-btn', function() {
            ...
            let deleteUrl = '{{ route('Channai44Controller.destroy', ['Channai44Controller' => 'id']) }}'.replace(
                'id', userId);
        ...
        $('#data_update_btn').on('click', function(e) {
            ...
            let updateUrl = '{{ route('Channai44Controller.update', ['Channai44Controller' => ':id']) }}'.replace(
                ':id', userId);
    ...
    function fetchData() {
        $.ajax({
            url: '{{ route('Channai44Controller.index') }}',
            type: 'GET',
