    ...
    <script>
        $(document).ready(function() {
            ...
            $('#data_submit_btn').on('click', function(e) {
                ...
                $.ajax({
                    url: '{{ route('Channai21Controller.store') }}',
                    method: 'POST',
                    data: formData,
            ...
            $(document).on('click', '.edit-btn', function() {
                ...
                $('#data-id').val();
                let editteUrl = '{{ route('Channai21Controller.edit', ['Channai21Controller' => 'id']) }}'
                    .replace(
                        'id', userId);
            ...
            $(document).on('click', '.delete-btn', function() {
                ...
                let deleteUrl =
                    '{{ route('Channai21Controller.destroy', ['Channai21Controller' => 'id']) }}'.replace(
                        'id', userId);
            ...
            $('#data_update_btn').on('click', function(e) {
                ...
                let updateUrl =
                    '{{ route('Channai21Controller.update', ['Channai21Controller' => ':id']) }}'.replace(
                        ':id', userId);
        ...
        function fetchData() {
            $.ajax({
                url: '{{ route('Channai21Controller.index') }}',
                type: 'GET',
