    <div>
        <form method='post' id='data_input_form' name='data_input_form'>
            ...
            <lable> ii:</lable>
            <input class= "integer" id="ii" name="ii" /><br /> <br />

            <lable> i:</lable>
            <input class= "integer" id="i" name="i" /><br /> <br />
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.edit-btn', function() {
                    ...
                    $('#data-id').val();
                    let editteUrl = '{{ route('IiController.edit', ['IiController' => 'id']) }}'.replace(
                        'id', userId);
        ...
        $(document).on('click', '.delete-btn', function() {
            ...
            let deleteUrl = '{{ route('IiController.destroy', ['IiController' => 'id']) }}'.replace(
                'id', userId);
        ...
        $('#data_update_btn').on('click', function() {
            ...
            let updateUrl = '{{ route('IiController.update', ['IiController' => ':id']) }}'.replace(
                ':id', userId);
