    <div>
    <form method='post' id='data_input_form' action='{{route('Table_1Controller.store')}}' name='data_input_form'>
    @csrf
                ...
                <lable> email:</lable>
                <input class= "integer"  , name="email"/> <br/> <br/>
    ...
    $(document).ready(function(){
     $.ajax({
                url: "{{  route('Table_1Controller.index')}}",
                type: "get",
                data: {},
