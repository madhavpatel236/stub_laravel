    ...
    <script>
        ...
        $(document).on('click', '.edit-btn', function() {
            ...
            $('#data-id').val();
            let editteUrl = '{{ route('Rr4Controller.edit', ['Rr4Controller' => 'id']) }}'.replace(
                'id', userId);
        ...
        $(document).on('click', '.delete-btn', function() {
            ...
            let deleteUrl = '{{ route('Rr4Controller.destroy', ['Rr4Controller' => 'id']) }}'.replace(
                'id', userId);
        ...
        $('#data_update_btn').on('click', function() {
            ...
            let updateUrl = '{{ route('Rr4Controller.update', ['Rr4Controller' => ':id']) }}'.replace(
                ':id', userId);
...
if(rr == "" || rr == null){
 ...
 if(typeof rr == 'string' == 'integer' && rr.length() > ){
                $('#rr_error').html(' Max allowed field length is: ')
            flag = false;
                }
if (flag != true) {
                    e.preventDefault();
