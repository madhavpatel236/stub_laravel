    <div>
    <form method='post' id='data_input_form' action='{{route('Demo17Controller.store')}}' name='data_input_form'>
    @csrf
    
                <lable> dsvc:</lable>
                <input class= "integer"  , name="dsvc"/> <br/> <br/>
    ...
    $(document).ready(function(){
     $.ajax({
                url: "{{  route('Demo17Controller.index')}}",
                type: "get",
                data: {},
