    <div>
    <form method='post' id='data_input_form' action='{{route('QwertController.store')}}' name='data_input_form'>
    @csrf
    
                <lable> qwert:</lable>
                <input class= "integer"  , name="qwert"/> <br/> <br/>
    ...
    $(document).ready(function(){
     $.ajax({
                url: "{{  route('QwertController.index')}}",
                type: "get",
                data: {},
