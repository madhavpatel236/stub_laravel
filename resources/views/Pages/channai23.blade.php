    ...
    <script>
        $(document).ready(function() {
            ...
            $('#data_submit_btn').on('click', function(e) {
                $.ajax({
                    url: '{{ route('Channai23Controller.store') }}',
                    method: 'POST',
                    data: {
                        _token: '{{ csrf_token() }}',
                        // name: $('#name').val(),
            ...
            $(document).on('click', '.edit-btn', function() {
                ...
                $('#data-id').val();
                let editteUrl = '{{ route('Channai23Controller.edit', ['Channai23Controller' => 'id']) }}'
                    .replace(
                        'id', userId);
            ...
            $(document).on('click', '.delete-btn', function() {
                ...
                let deleteUrl =
                    '{{ route('Channai23Controller.destroy', ['Channai23Controller' => 'id']) }}'.replace(
                        'id', userId);
            ...
            $('#data_update_btn').on('click', function(e) {
                ...
                let updateUrl =
                    '{{ route('Channai23Controller.update', ['Channai23Controller' => ':id']) }}'.replace(
                        ':id', userId);
        ...
        function fetchData() {
            $.ajax({
                url: '{{ route('Channai23Controller.index') }}',
                type: 'GET',
