    ...
    <script>
            ...
            $.ajax({
                url: '{{ route('Channai46Controller.store') }}',
                method: 'POST',
        ...
        $(document).on('click', '.edit-btn', function() {
            ...
            $('#data-id').val();
            let editteUrl = '{{ route('Channai46Controller.edit', ['Channai46Controller' => 'id']) }}'.replace(
                'id', userId);
        ...
        $(document).on('click', '.delete-btn', function() {
            ...
            let deleteUrl = '{{ route('Channai46Controller.destroy', ['Channai46Controller' => 'id']) }}'.replace(
                'id', userId);
        ...
        $('#data_update_btn').on('click', function(e) {
            ...
            let updateUrl = '{{ route('Channai46Controller.update', ['Channai46Controller' => ':id']) }}'.replace(
                ':id', userId);
    ...
    function fetchData() {
        $.ajax({
            url: '{{ route('Channai46Controller.index') }}',
            type: 'GET',
