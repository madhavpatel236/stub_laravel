    <div>
        <form method='post' id='data_input_form' name='data_input_form'>
            ...
            <lable> TTTT:</lable>
            <input class= "integer" id="TTTT"name="TTTT" /><br /> <br />

            <lable> T:</lable>
            <input class= "integer" id="T"name="T" /><br /> <br />
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#data_submit_btn').on('click', function() {
                ...
                $.ajax({
                    url: '{{ route('TTTTController.store') }}',
                    method: 'POST',
                    data: formData,
            ...
            $(document).on('click', '.edit-btn', function() {
                ...
                $('#data-id').val();
                let editteUrl = '{{ route('TTTTController.edit', ['TTTTController' => 'id']) }}'.replace(
                    'id', userId);
            ...
            $(document).on('click', '.delete-btn', function() {
                ...
                let deleteUrl = '{{ route('TTTTController.destroy', ['TTTTController' => 'id']) }}'.replace(
                    'id', userId);
            ...
            $('#data_update_btn').on('click', function() {
                ...
                let updateUrl = '{{ route('TTTTController.update', ['TTTTController' => ':id']) }}'.replace(
                    ':id', userId);
        ...
        function fetchData() {
            ...
            $.ajax({
                url: '{{ route('TTTTController.index') }}',
                type: 'GET',
