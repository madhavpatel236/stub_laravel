    ...
    @csrf
                ...
                <lable> name:</lable>
                <input class= "binary" id="name" name="name"/>
                <span class= "binary_error" id="name_error" name="name_error"></span><br/> <br/>
    ...
    <script>
            ...
            $.ajax({
                url: '{{ route('Channai41Controller.store') }}',
                method: 'POST',
        ...
        $(document).on('click', '.edit-btn', function() {
            ...
            $('#data-id').val();
            let editteUrl = '{{ route('Channai41Controller.edit', ['Channai41Controller' => 'id']) }}'.replace(
                'id', userId);
        ...
        $(document).on('click', '.delete-btn', function() {
            ...
            let deleteUrl = '{{ route('Channai41Controller.destroy', ['Channai41Controller' => 'id']) }}'.replace(
                'id', userId);
        ...
        $('#data_update_btn').on('click', function(e) {
            ...
            let updateUrl = '{{ route('Channai41Controller.update', ['Channai41Controller' => ':id']) }}'.replace(
                ':id', userId);
    ...
    function fetchData() {
        $.ajax({
            url: '{{ route('Channai41Controller.index') }}',
            type: 'GET',
