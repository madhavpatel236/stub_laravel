    <div>
    <form method='post' id='data_input_form' action='{{route('TttController.store')}}' name='data_input_form'>
    @csrf
    
                <lable> ttt:</lable>
                <input class= "integer"  , name="ttt"/> <br/> <br/>
