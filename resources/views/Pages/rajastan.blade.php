    ...
    <script>
        $(document).ready(function() {
            ...
            $('#data_submit_btn').on('click', function() {
                ...
                $.ajax({
                    url: '{{ route('RajastanController.store') }}',
                    method: 'POST',
                    data: formData,
            ...
            $(document).on('click', '.edit-btn', function() {
                ...
                $('#data-id').val();
                let editteUrl = '{{ route('RajastanController.edit', ['RajastanController' => 'id']) }}'
                    .replace(
                        'id', userId);
            ...
            $(document).on('click', '.delete-btn', function() {
                ...
                let deleteUrl = '{{ route('RajastanController.destroy', ['RajastanController' => 'id']) }}'
                    .replace(
                        'id', userId);
            ...
            $('#data_update_btn').on('click', function() {
                ...
                let updateUrl = '{{ route('RajastanController.update', ['RajastanController' => ':id']) }}'
                    .replace(
                        ':id', userId);
        ...
        function fetchData() {
            $.ajax({
                url: '{{ route('RajastanController.index') }}',
                type: 'GET',
                success: function(res) {
                    ...
                    data.forEach(function(row) {
                        ...
                        '<button class='delete - btn ' data-id=' + row.id + '>Delete</button> ' +'</td>';
                        rows += '</tr>';
