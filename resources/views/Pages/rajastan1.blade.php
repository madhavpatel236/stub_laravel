    ...
    <script>
        $(document).ready(function() {
            ...
            $('#data_submit_btn').on('click', function() {
                ...
                $.ajax({
                    url: '{{ route('Rajastan1Controller.store') }}',
                    method: 'POST',
                    data: formData,
            ...
            $(document).on('click', '.edit-btn', function() {
                ...
                $('#data-id').val();
                let editteUrl = '{{ route('Rajastan1Controller.edit', ['Rajastan1Controller' => 'id']) }}'
                    .replace(
                        'id', userId);
            ...
            $(document).on('click', '.delete-btn', function() {
                ...
                let deleteUrl =
                    '{{ route('Rajastan1Controller.destroy', ['Rajastan1Controller' => 'id']) }}'.replace(
                        'id', userId);
            ...
            $('#data_update_btn').on('click', function() {
                ...
                let updateUrl =
                    '{{ route('Rajastan1Controller.update', ['Rajastan1Controller' => ':id']) }}'.replace(
                        ':id', userId);
        ...
        function fetchData() {
            $.ajax({
                url: '{{ route('Rajastan1Controller.index') }}',
                type: 'GET',
