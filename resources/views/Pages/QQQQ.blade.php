    ...
    <script>
            ...
            $.ajax({
                url: '{{ route('QQQQController.store') }}',
                method: 'POST',
                data: formData,
        ...
        $(document).on('click', '.edit-btn', function() {
            ...
            $('#data-id').val();
            let editteUrl = '{{ route('QQQQController.edit', ['QQQQController' => 'id']) }}'.replace(
                'id', userId);
        ...
        $(document).on('click', '.delete-btn', function() {
            ...
            let deleteUrl = '{{ route('QQQQController.destroy', ['QQQQController' => 'id']) }}'.replace(
                'id', userId);
        ...
        $('#data_update_btn').on('click', function() {
            ...
            let updateUrl = '{{ route('QQQQController.update', ['QQQQController' => ':id']) }}'.replace(
                ':id', userId);
    ...
    function fetchData() {
        $.ajax({
            url: '{{ route('QQQQController.index') }}',
            type: 'GET',
