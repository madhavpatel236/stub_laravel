    ...
    @csrf
                ...
                <lable> E:</lable>
                <input class= "integer" id="E"name="E"/><br/> <br/>
    ...
    <script>
        ...
        $(document).on('click', '.edit-btn', function() {
            ...
            $('#data-id').val();
            let editteUrl = '{{ route('EEEController.edit', ['EEEController' => 'id']) }}'.replace(
                'id', userId);
        ...
        $(document).on('click', '.delete-btn', function() {
            ...
            let deleteUrl = '{{ route('EEEController.destroy', ['EEEController' => 'id']) }}'.replace(
                'id', userId);
        ...
        $('#data_update_btn').on('click', function() {
            ...
            let updateUrl = '{{ route('EEEController.update', ['EEEController' => ':id']) }}'.replace(
                ':id', userId);
