    ...
    <script>
            ...
            $.ajax({
                url: '{{ route('Channai8Controller.store') }}',
                method: 'POST',
                data: formData,
        ...
        $(document).on('click', '.edit-btn', function() {
            ...
            $('#data-id').val();
            let editteUrl = '{{ route('Channai8Controller.edit', ['Channai8Controller' => 'id']) }}'.replace(
                'id', userId);
        ...
        $(document).on('click', '.delete-btn', function() {
            ...
            let deleteUrl = '{{ route('Channai8Controller.destroy', ['Channai8Controller' => 'id']) }}'.replace(
                'id', userId);
        ...
        $('#data_update_btn').on('click', function() {
            ...
            let updateUrl = '{{ route('Channai8Controller.update', ['Channai8Controller' => ':id']) }}'.replace(
                ':id', userId);
    ...
    function fetchData() {
        $.ajax({
            url: '{{ route('Channai8Controller.index') }}',
            type: 'GET',
...
if(age == "" || age == null){
 ...
 if(age.length() >  3){
                $('#age_error').html(' Max allowed field length is: 3')
            flag = false;
                }
if(age != ^[0-9]){
