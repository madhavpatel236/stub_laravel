    ...
    <script>
            ...
            $.ajax({
                url: '{{ route('Channai20Controller.store') }}',
                method: 'POST',
                data: formData,
        ...
        $(document).on('click', '.edit-btn', function() {
            ...
            $('#data-id').val();
            let editteUrl = '{{ route('Channai20Controller.edit', ['Channai20Controller' => 'id']) }}'.replace(
                'id', userId);
        ...
        $(document).on('click', '.delete-btn', function() {
            ...
            let deleteUrl = '{{ route('Channai20Controller.destroy', ['Channai20Controller' => 'id']) }}'.replace(
                'id', userId);
        ...
        $('#data_update_btn').on('click', function(e) {
            ...
            let updateUrl = '{{ route('Channai20Controller.update', ['Channai20Controller' => ':id']) }}'.replace(
                ':id', userId);
    ...
    function fetchData() {
        $.ajax({
            url: '{{ route('Channai20Controller.index') }}',
            type: 'GET',
