    <div>
    <form method='post' id='data_input_form' action='{{route('Table_nameController.store')}}' name='data_input_form'>
    @csrf
    
                <lable> dfc:</lable>
                <input class= "integer"  , name="dfc"/> <br/> <br/>
    ...
    $(document).ready(function(){
     $.ajax({
                url: "{{  route('Table_nameController.index')}}",
                type: "get",
                data: {},
