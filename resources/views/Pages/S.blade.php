    ...
    @csrf
                ...
                <lable> SSS:</lable>
                <input class= "integer" id="SSS"name="SSS"/><br/> <br/>
    ...
    <script>
        ...
        $(document).on('click', '.edit-btn', function() {
            ...
            $('#data-id').val();
            let editteUrl = '{{ route('SController.edit', ['SController' => 'id']) }}'.replace(
                'id', userId);
        ...
        $(document).on('click', '.delete-btn', function() {
            ...
            let deleteUrl = '{{ route('SController.destroy', ['SController' => 'id']) }}'.replace(
                'id', userId);
        ...
        $('#data_update_btn').on('click', function() {
            ...
            let updateUrl = '{{ route('SController.update', ['SController' => ':id']) }}'.replace(
                ':id', userId);
