    <div>
    <form method='post' id='data_input_form' action='{{route('TtController.store')}}' name='data_input_form'>
    @csrf
    
                <lable> 22:</lable>
                <input class= "integer"  , name="22"/> <br/> <br/>
            
                <lable> ff:</lable>
                <input class= "integer"  , name="ff"/> <br/> <br/>
