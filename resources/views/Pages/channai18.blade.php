    ...
    <script>
        $(document).ready(function() {
            ...
            $('#data_submit_btn').on('click', function(e) {
                ...
                $.ajax({
                    url: '{{ route('Channai18Controller.store') }}',
                    method: 'POST',
                    data: formData,
            ...
            $(document).on('click', '.edit-btn', function() {
                ...
                $('#data-id').val();
                let editteUrl = '{{ route('Channai18Controller.edit', ['Channai18Controller' => 'id']) }}'
                    .replace(
                        'id', userId);
            ...
            $(document).on('click', '.delete-btn', function() {
                ...
                let deleteUrl =
                    '{{ route('Channai18Controller.destroy', ['Channai18Controller' => 'id']) }}'.replace(
                        'id', userId);
            ...
            $('#data_update_btn').on('click', function(e) {
                ...
                let updateUrl =
                    '{{ route('Channai18Controller.update', ['Channai18Controller' => ':id']) }}'.replace(
                        ':id', userId);
        ...
        function fetchData() {
            $.ajax({
                url: '{{ route('Channai18Controller.index') }}',
                type: 'GET',
