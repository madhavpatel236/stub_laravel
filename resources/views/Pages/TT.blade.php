    ...
    @csrf
                ...
                <lable> TT:</lable>
                <input class= "integer" id="TT"name="TT"/><br/> <br/>
            
                <lable> TTT:</lable>
                <input class= "integer" id="TTT"name="TTT"/><br/> <br/>
    ...
    <script>
        ...
        $(document).on('click', '.edit-btn', function() {
            ...
            $('#data-id').val();
            let editteUrl = '{{ route('TTController.edit', ['TTController' => 'id']) }}'.replace(
                'id', userId);
        ...
        $(document).on('click', '.delete-btn', function() {
            ...
            let deleteUrl = '{{ route('TTController.destroy', ['TTController' => 'id']) }}'.replace(
                'id', userId);
        ...
        $('#data_update_btn').on('click', function() {
            ...
            let updateUrl = '{{ route('TTController.update', ['TTController' => ':id']) }}'.replace(
                ':id', userId);
