    ...
    <script>
        $(document).ready(function() {
            ...
            $('#data_submit_btn').on('click', function(e) {
                $.ajax({
                    url: '{{ route('Rcb12Controller.store') }}',
                    method: 'POST',
            ...
            $(document).on('click', '.edit-btn', function() {
                ...
                $('#data-id').val();
                let editteUrl = '{{ route('Rcb12Controller.edit', ['Rcb12Controller' => 'id']) }}'.replace(
                    'id', userId);
            ...
            $(document).on('click', '.delete-btn', function() {
                ...
                let deleteUrl = '{{ route('Rcb12Controller.destroy', ['Rcb12Controller' => 'id']) }}'
                    .replace(
                        'id', userId);
            ...
            $('#data_update_btn').on('click', function(e) {
                ...
                let updateUrl = '{{ route('Rcb12Controller.update', ['Rcb12Controller' => ':id']) }}'
                    .replace(
                        ':id', userId);
        ...
        function fetchData() {
            $.ajax({
                url: '{{ route('Rcb12Controller.index') }}',
                type: 'GET',
