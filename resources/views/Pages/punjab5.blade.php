    ...
    <script>
        $(document).ready(function() {
            ...
            $('#data_submit_btn').on('click', function() {
                ...
                $.ajax({
                    url: '{{ route('Punjab5Controller.store') }}',
                    method: 'POST',
                    data: formData,
            ...
            $(document).on('click', '.edit-btn', function() {
                ...
                $('#data-id').val();
                let editteUrl = '{{ route('Punjab5Controller.edit', ['Punjab5Controller' => 'id']) }}'
                    .replace(
                        'id', userId);
            ...
            $(document).on('click', '.delete-btn', function() {
                ...
                let deleteUrl = '{{ route('Punjab5Controller.destroy', ['Punjab5Controller' => 'id']) }}'
                    .replace(
                        'id', userId);
            ...
            $('#data_update_btn').on('click', function() {
                ...
                let updateUrl = '{{ route('Punjab5Controller.update', ['Punjab5Controller' => ':id']) }}'
                    .replace(
                        ':id', userId);
        ...
        function fetchData() {
            $.ajax({
                url: '{{ route('Punjab5Controller.index') }}',
                type: 'GET',
