    ...
    <script>
        $(document).ready(function() {
            ...
            $('#data_submit_btn').on('click', function(e) {
                $.ajax({
                    url: '{{ route('Rcb13Controller.store') }}',
                    method: 'POST',
            ...
            $(document).on('click', '.edit-btn', function() {
                ...
                $('#data-id').val();
                let editteUrl = '{{ route('Rcb13Controller.edit', ['Rcb13Controller' => 'id']) }}'.replace(
                    'id', userId);
            ...
            $(document).on('click', '.delete-btn', function() {
                ...
                let deleteUrl = '{{ route('Rcb13Controller.destroy', ['Rcb13Controller' => 'id']) }}'
                    .replace(
                        'id', userId);
            ...
            $('#data_update_btn').on('click', function(e) {
                ...
                let updateUrl = '{{ route('Rcb13Controller.update', ['Rcb13Controller' => ':id']) }}'
                    .replace(
                        ':id', userId);
        ...
        function fetchData() {
            $.ajax({
                url: '{{ route('Rcb13Controller.index') }}',
                type: 'GET',
