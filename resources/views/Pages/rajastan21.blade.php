    ...
    <script>
        ...
        $(document).on('click', '.edit-btn', function() {
            ...
            $('#data-id').val();
            let editteUrl = '{{ route('Rajastan21Controller.edit', ['Rajastan21Controller' => 'id']) }}'.replace(
                'id', userId);
        ...
        $(document).on('click', '.delete-btn', function() {
            ...
            let deleteUrl = '{{ route('Rajastan21Controller.destroy', ['Rajastan21Controller' => 'id']) }}'.replace(
                'id', userId);
        ...
        $('#data_update_btn').on('click', function() {
            ...
            let updateUrl = '{{ route('Rajastan21Controller.update', ['Rajastan21Controller' => ':id']) }}'.replace(
                ':id', userId);
