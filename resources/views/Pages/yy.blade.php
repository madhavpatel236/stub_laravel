    <div>
        <form method='post' id='data_input_form' name='data_input_form'>
            ...
            <lable> y:</lable>
            <input class= "string" id="y" name="y" /><br /> <br />

            <lable> yy:</lable>
            <input class= "integer" id="yy" name="yy" /><br /> <br />
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.edit-btn', function() {
                    ...
                    $('#data-id').val();
                    let editteUrl = '{{ route('YyController.edit', ['YyController' => 'id']) }}'.replace(
                        'id', userId);
        ...
        $(document).on('click', '.delete-btn', function() {
            ...
            let deleteUrl = '{{ route('YyController.destroy', ['YyController' => 'id']) }}'.replace(
                'id', userId);
        ...
        $('#data_update_btn').on('click', function() {
            ...
            let updateUrl = '{{ route('YyController.update', ['YyController' => ':id']) }}'.replace(
                ':id', userId);
    ...
    <script>
        var y = $('#y').val().trim();
        if (y = "") {
            $('#y_error').val('y is required!!')
        }
        12
        var yy = $('#yy').val().trim();
        if (yy = "") {
            $('#yy_error').val('yy is required!!')
        }
    </script>
