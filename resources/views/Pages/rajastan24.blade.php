    ...
    <script>
            ...
            $.ajax({
                url: '{{ route('Rajastan24Controller.store') }}',
                method: 'POST',
                data: formData,
        ...
        $(document).on('click', '.edit-btn', function() {
            ...
            $('#data-id').val();
            let editteUrl = '{{ route('Rajastan24Controller.edit', ['Rajastan24Controller' => 'id']) }}'.replace(
                'id', userId);
        ...
        $(document).on('click', '.delete-btn', function() {
            ...
            let deleteUrl = '{{ route('Rajastan24Controller.destroy', ['Rajastan24Controller' => 'id']) }}'.replace(
                'id', userId);
        ...
        $('#data_update_btn').on('click', function() {
            ...
            let updateUrl = '{{ route('Rajastan24Controller.update', ['Rajastan24Controller' => ':id']) }}'.replace(
                ':id', userId);
    ...
    function fetchData() {
        $.ajax({
            url: '{{ route('Rajastan24Controller.index') }}',
            type: 'GET',
