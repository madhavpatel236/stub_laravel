    ...
    <script>
            ...
            $.ajax({
                url: '{{ route('Channai42Controller.store') }}',
                method: 'POST',
        ...
        $(document).on('click', '.edit-btn', function() {
            ...
            $('#data-id').val();
            let editteUrl = '{{ route('Channai42Controller.edit', ['Channai42Controller' => 'id']) }}'.replace(
                'id', userId);
        ...
        $(document).on('click', '.delete-btn', function() {
            ...
            let deleteUrl = '{{ route('Channai42Controller.destroy', ['Channai42Controller' => 'id']) }}'.replace(
                'id', userId);
        ...
        $('#data_update_btn').on('click', function(e) {
            ...
            let updateUrl = '{{ route('Channai42Controller.update', ['Channai42Controller' => ':id']) }}'.replace(
                ':id', userId);
    ...
    function fetchData() {
        $.ajax({
            url: '{{ route('Channai42Controller.index') }}',
            type: 'GET',
