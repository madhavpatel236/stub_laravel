    ...
    <script>
            ...
            $.ajax({
                url: '{{ route('Channai19Controller.store') }}',
                method: 'POST',
                data: formData,
        ...
        $(document).on('click', '.edit-btn', function() {
            ...
            $('#data-id').val();
            let editteUrl = '{{ route('Channai19Controller.edit', ['Channai19Controller' => 'id']) }}'.replace(
                'id', userId);
        ...
        $(document).on('click', '.delete-btn', function() {
            ...
            let deleteUrl = '{{ route('Channai19Controller.destroy', ['Channai19Controller' => 'id']) }}'.replace(
                'id', userId);
        ...
        $('#data_update_btn').on('click', function(e) {
            ...
            let updateUrl = '{{ route('Channai19Controller.update', ['Channai19Controller' => ':id']) }}'.replace(
                ':id', userId);
    ...
    function fetchData() {
        $.ajax({
            url: '{{ route('Channai19Controller.index') }}',
            type: 'GET',
