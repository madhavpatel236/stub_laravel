    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.edit-btn', function() {
                    ...
                    $('#data-id').val();
                    let editteUrl = '{{ route('IiiController.edit', ['IiiController' => 'id']) }}'.replace(
                        'id', userId);
        ...
        $(document).on('click', '.delete-btn', function() {
            ...
            let deleteUrl = '{{ route('IiiController.destroy', ['IiiController' => 'id']) }}'.replace(
                'id', userId);
        ...
        $('#data_update_btn').on('click', function() {
            ...
            let updateUrl = '{{ route('IiiController.update', ['IiiController' => ':id']) }}'.replace(
                ':id', userId);
    ...
    <script>
        $(document).ready(function() {
            ...
            if (typeof iii == 'string' && iii.length() > ) {
                $('#iii_error').val(' Max allowed field length is: ')
            }
        })
    </script>
